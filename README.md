...
#### Deployment is done using [deploy](https://github.com/sarthakbora12/BostonHousePrice-Predictor) branch
...
- Clone the complete project with `https://github.com/sarthakbora12/BostonHousePrice-Predictor.git` or you can just download the code and unzip it
...
#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/sarthakbora)
